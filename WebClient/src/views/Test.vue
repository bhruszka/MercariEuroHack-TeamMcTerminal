<template>
    <GmapMap :center="center" :zoom="12" class="poly-map" :options="options">
        <div v-for="(element, index) in data" :key="index" class="marker-marker">
            <gmap-marker class="marker-marker" v-for="(m, index2) in element.path" :position="m" :key="index2" :icon="'https://carpooling.com.pl:4242/'+element.users[index2].avatar"></gmap-marker>
...
<style>
img[src*="https://carpooling.com.pl:4242"] {
  border-radius: 25px;
}
</style>
